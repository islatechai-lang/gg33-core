...
export default function Course() {
  ...
  if (!course) {
    return (
      <>
        <StarField />
        <Navigation />
        <main className="pt-4 sm:pt-6 lg:pt-20 pb-20 lg:pb-12 px-4 min-h-screen" data-testid="page-course-not-found">
  ...
  return (
    <>
      ...
      <main className="pt-4 sm:pt-6 lg:pt-20 pb-20 lg:pb-12 px-4 min-h-screen" data-testid="page-course">
                    ...
                    <Link href={`${basePath}/learn/${courseId}/${lesson.id}`}>
                      <CardContent className="py-4">
                        <div className="flex items-center gap-4">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold ${completed
